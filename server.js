...
app.post("/research", async (req, res) => {
  ...
  try {
    ...
    if (articles.length === 0) {
      return res.json({
        content: "<p>No relevant articles found for this topic.</p>",
      });
    }
    ...
    const formatted = articles
      ...
      <div style="margin-bottom: 30px;">
        ...
        ${
          article.image
            ? `<img src="${article.image}" alt="image" style="max-width:100%; margin-top:10px;" />`
            : ""
        }
      </div>
    `
      ...
      messages: [
        {
          role: "system",
          content:
            "You are a professional Australian mining trade journalist and editor. Improve the article based on the user's instruction while keeping tone, structure, and authenticity natural and human.",
        },
        {
          role: "user",
